output "combined_private_link_private_dns_zones_replaced_with_vnets_to_link" {
  ...
  value       = var.deploy_region_specific_zones_only? local.combined_private_link_private_dns_zones_replaced_with_vnets_to_link_only_multi_region_zones : local.combined_private_link_private_dns_zones_replaced_with_vnets_to_link
}
